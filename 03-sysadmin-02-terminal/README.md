...
Возможно источник не точен [https://en.wikipedia.org/wiki/Process_identifier](https://en.wikipedia.org/wiki/Process_identifier)  
Абзац #3. Первоначально не был зарезервирован, был просто первым. Позднее зарезервирован для совместимости.  
...
[screenshot #10a](https://i.imgur.com/w4mMPHX.png)  
![screenshot #10a](https://i.imgur.com/w4mMPHX.png)  
...
[screenshot #14a](https://i.imgur.com/ITdcnGs.png)  
![screenshot #14a](https://i.imgur.com/ITdcnGs.png)  
Первоначально запускал отдельно вывод stdout и stderr. Ок, теперь одновременно.  
А пример `ls 1< /tmp/1` был взят со страницы 21 Презентации к текущему занятию, как один из вариантов выводящий в stderr.  

Также, ожидаемый вариант:  
[screenshot #14b](https://i.imgur.com/W3WsQOx.png)  
![screenshot #14b](https://i.imgur.com/W3WsQOx.png)  
